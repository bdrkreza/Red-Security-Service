...
const CreateService = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch('https://redserviceguard.herokuapp.com/addService', {
            method: 'POST',
            body: formData
        })
            .then(res => res.json())
                ...
                <div className="crete-form">
                    <form onSubmit={handleSubmit(onSubmit)} className="contact-form  row">
                        ...
                        <div className="form-field col-lg-12">
                            <input {...register("description", { required: true })} id="description" className="input-text js-input" type="text" />
