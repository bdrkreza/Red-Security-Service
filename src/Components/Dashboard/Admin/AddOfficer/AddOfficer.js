...
const AddOfficer = () => {
    ...
    return (
        <div style={{ marginLeft: "250px" }}>
            <div className="card card-body w-75 py-5 bg-secondary">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row d-flex justify-content-lg-around ">
                        <div className="col-lg-6">
                            <div class="group">
                                <input {...register("name", { required: true })} type="text" placeholder="Enter officer Name..." />
                                <div>
                            ...
                            <div class="group">
                                <input {...register("designation", { required: true })} type="text" placeholder="Enter Designation Name.." />
                                <div>
                                    {errors.designation && <span>This Designation is required</span>}
                                </div>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            </div>
                            <div className="form-group">
                                <div className="inputGroupContainer">
                                    <div className="input-group">
                                        ...
                                        <textarea {...register("description", { required: true })} className="form-control" placeholder="Write Officers Details" id="review" rows="3"></textarea>
                                    </div>
                                    <div className="ml-5">
